...
module.exports = {
    ...
    searchProducts: (req, res) => {
        ...
        const pageSize = 16; // Tamaño de página (número de resultados por página)
...
// En tu módulo de controlador de productos
    ...
    createNewProduct: (req, res) => {
        ...
        const newProduct = new ProductModel({
            ...
            imageUrl: `http://localhost:8000/api/uploads/${imageName}` // Asignar el nombre de la imagen a req.body.imageUrl
        });
